...
function Pipe:render()
    ...
    shiftedY = self.orientation == 'top' and self.y + PIPE_HEIGHT or self.y
    rotation = 0;
    scaleX = 1
    scaleY = self.orientation == 'top' and -1 or 1
    love.graphics.draw(PIPE_IMAGE, self.x, shiftedY, rotation, scaleX, scaleY)
end